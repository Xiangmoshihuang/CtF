...
from backbone.vit_prompts import MoEPrompt as Prompt
...
class MoE_Prompt(Finetune_IL):
    ...
    def __init__(self, logger, config):
        ...
        if self._incre_type != 'cil':
            raise ValueError('MoE_Prompt is a class incremental method!')
    
    def prepare_model(self, checkpoint=None):
        if self._network == None:
            prompt_module = Prompt(512, 768, self._prompt_length)
    ...
    def _epoch_train(self, model, train_loader, optimizer, scheduler, task_begin=None, task_end=None, task_id=None):
        ...
        for _, inputs, targets in train_loader:
            ...
            logits, _ = model(inputs, train=True)
