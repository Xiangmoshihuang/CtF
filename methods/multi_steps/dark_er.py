...
class Dark_ER(Finetune_IL):
    ...
    def __init__(self, logger, config):
        ...
        logger.info('Applying Dark_ER (a class incremental method, test with {})'.format(self._incre_type))
    ...
    def prepare_task_data(self, data_manager):
        ...
        if self._text_inputs == None:
            if self.manual_temp:
                self.clip_text_input(data_manager._classes_name, data_manager._class_order)
            else:
                self.clip_text_input(data_manager._classes_name, data_manager._class_order, data_manager._prompts, prompt_num=self._prompt_num)
