...
from backbone.foster_net import FOSTERNet
...
def add_special_args(parser: ArgumentParser) -> ArgumentParser:
    ...
    parser.add_argument('--is_teacher_wa', type=bool, default=None)
    parser.add_argument('--is_student_wa', type=bool, default=None)
    parser.add_argument('--lambda_okd', type=float, default=None)
    parser.add_argument('--wa_value', type=float, default=None)
    parser.add_argument('--oofc', type=str, default=None)
    return parser

class FOSTER(Finetune_IL):    
    def __init__(self, logger, config):
        ...
        logger.info('Applying FOSTER (a class incremental method, test with {})'.format(self._incre_type))

    def prepare_model(self, checkpoint=None):
        if self._network == None:
            self._network = FOSTERNet(self._logger, self._config.backbone, self._config.pretrained, self._config.pretrain_path)
