...
# author="Douillard Arthur, Cord Matthieu, Ollion Charles, Robert Thomas, Valle Eduardo",
# editor="Vedaldi Andrea, Bischof Horst, Brox Thomas, Frahm, Jan-Michael",
...
class PODNet(Finetune_IL):
    ...
    def __init__(self, logger, config):
        ...
        logger.info('Applying PODNet (a class incremental method, test with {})'.format(self._incre_type))
