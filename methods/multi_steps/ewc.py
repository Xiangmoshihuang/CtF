...
def add_special_args(parser: ArgumentParser) -> ArgumentParser:
    parser.add_argument('--fishermax', type=float, default=None, help='fishermax for ewc')
    parser.add_argument('--lamda', type=float, default=None, help='lambda for ewc or lwf')
    return parser
