...
class Config:
    ...
    def __init__(self, config_mode=None):
        ...
        parser.add_argument('--prompt_num', type=int, default=None, help='the template nums of CLIP interference')
        parser.add_argument('--manual_temp', action="store_true", default=None, help='whether use manual template, eg, a photo of...')
        ...
        parser.add_argument('--top_k', type=int, default=None, help='top_k acc')
        ...
        # configs after training (test, save models or )
