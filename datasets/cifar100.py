...
class CIFAR100(iData):
    ...
    def download_data(self):
        ...
        meta_Name = os.path.join(os.environ['DATA'], "cifar-100-python", "meta")
        Meta_dic= self.unpickle(meta_Name)
        coarse_label_names=Meta_dic['coarse_label_names']
        fine_label_names=Meta_dic['fine_label_names']
        self.classes_name = fine_label_names

        template_json_path = os.path.join("datasets","all_prompts","cifar100_prompts_base.json")
